...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link" href="https://arbitrajevar.cl">Inicio</a></li>
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Bienvenido a Arbitraje VAR</div>
            <div class="masthead-heading text-uppercase">Tecnología Aplicada Al Futbol</div>
            <a class="btn btn-primary btn-xl text-uppercase" href="#contact">Contratar</a>
        </div>
    </header>
    <!-- Services-->
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted" style="text-align: center;">El futbol y la tecnología es nuestra pasion.</h3>
            </div>
            ...
            <div class="row text-center mt-5">
                <div class="col-md-4 mb-5">
                    ...
                    <h4 class="my-3">Arbitraje VAR</h4>
                    <p class="text-muted">Servicio completo de árbitros, VAR, grabaciones, traslado. Ideal para finales o ligas profesionales.</p>
                </div>
                <div class="col-md-4 mb-5">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="my-3">Solo VAR</h4>
                    <p class="text-muted">Tecnología de video-arbitraje para ligas juveniles, amistosos y eventos deportivos corporativos.</p>
                </div>
                <div class="col-md-4 mb-5">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="my-3">Videos y Grabaciones</h4>
                    <p class="text-muted">Captura de jugadas clave en alta definición, listas para descarga y análisis inmediato.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Escribenos y te contactamos a la brevedad</h3>
            </div>
            <!-- Custom contact form: posts to n8n webhook via JS -->
            <form id="contactForm" novalidate action="{{ route('clients.formulario') }}" method="post" autocomplete="off">
                @csrf
                ...
                <div class="row align-items-stretch mb-5">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-textarea mb-md-0">
                            <!-- Message input-->
                            <textarea class="form-control" id="notes" name="notes" placeholder="Tu Mensaje *" required></textarea>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 my-3 my-lg-0">
                    ...
                    <!--<a class="btn btn-dark btn-social mx-2" href="#!" aria-label="LinkedIn"><i class="fa-brands fa-youtube"></i></a>-->
                </div>
